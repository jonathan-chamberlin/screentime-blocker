...
REG ADD "HKCU\Software\Google\Chrome\NativeMessagingHosts\com.brainrotblocker.native" /ve /t REG_SZ /d "%MANIFEST_PATH%" /f
...
if %ERRORLEVEL% EQU 0 (
    ...
    echo.
    echo The native messaging host is now registered with Chrome.
    echo Restart Chrome to use the extension.
    echo ========================================
) else (
    echo.
